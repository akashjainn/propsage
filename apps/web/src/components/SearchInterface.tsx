        ...
        <div className="space-y-6">
          ...
          {state.isLoading && (
            <div className="text-center space-y-2 text-green-400 text-sm">
              <div className="animate-pulse">Ì¥ç Searching lines...</div>
              <div className="animate-pulse">Ì≥∞ Gathering evidence...</div>
              <div className="animate-pulse">Ìæ• Finding clips...</div>
            </div>
          )}
