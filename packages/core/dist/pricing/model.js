export function applyEvidenceAdjustments(prior, evidence) {
...
export function monteCarloFairValue(inputs) {
    ...
    let overCount = 0;
    const samples = new Array(2000); // reservoir for CI / median approximation
    let sampleWrite = 0;
    for (let i = 0; i < N; i++) {
